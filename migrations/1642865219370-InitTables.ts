...
export class InitTables1642865219370 implements MigrationInterface {
    name = 'InitTables1642865219370'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "color" ("color_id" character varying NOT NULL, "color_name" character varying NOT NULL, CONSTRAINT "PK_25ee6a7dc7b5899a226a831e539" PRIMARY KEY ("color_id"))`);
